                            ...
                            <div id="comment-{{$item->id}}" class="comment-container">
                                <div class="comment-meta commentmetadata">
                                    ...
                                    <div class="comment-body">
                                        <p><a href='{{ route('api.blog.comments.show', ['post'=>$item->post_id,'comment' => $item->id]) }}'> ID: {{$item->id}} </a></p>
                                    ...
                                    <form method="GET" action="{{-- route('blog.comments.create') --}}">
                                      ...
                                      {{--  <input name="parent_id"
                                        ...
                                        <li class="nav-item">
                                        <a class="nav-link active" href="{{-- route('blog.comments.edit', $item->id) --}}"> Редактировать</a>
                                        </li>
